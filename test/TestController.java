...
public class TestController {
  ...
  public void testSaveBadDestination() throws IOException {
    ...
    assertEquals("WELCOME TO IMAGE PROCESSOR\n" +
                    ...
                    "... From: square ...\n" +
                    "... To: res/square.bad ...\n" +
                    " Unrecognized file suffix in filepath: res/square.bad. File path must end " +
                    "in one of: tif, jpg, tiff, bmp, gif, png, wbmp, jpeg.\n" +
                    "Bye!\n",
            this.mockOutput.toString());
  }
  ...
  public void testSaveBadDestination2() throws IOException {
    ...
    assertEquals("WELCOME TO IMAGE PROCESSOR\n" +
                    ...
                    "... From: square ...\n" +
                    "... To: bad ...\n" +
                    " Unrecognized file suffix in filepath: bad. File path must end " +
                    "in one of: tif, jpg, tiff, bmp, gif, png, wbmp, jpeg.\n" +
                    "Bye!\n",
            this.mockOutput.toString());
  }
